...
date: "2025-07-01"
thumbnail: "/assets/img/thumbnail/opencv.png"셋
---
...
- layers.Dense(len(class_names), activation='softmax'):   
  최종 출력 레이어입니다. len(class_names)는 하리보 젤리의 종류 수에 해당하며, softmax 활성화 함수는 각 클래스에 대한 확률 분포를 출력합니다. 모든 클래스의 확률 합은 1이 됩니다.
