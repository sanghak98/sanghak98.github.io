...
## I-Type: DataPath
![text](<../../../assets/img/vlsi2/250820/스크린샷 2025-08-21 092124.png>) 
...
## LU-Type: DataPath
![text](<../../../assets/img/vlsi2/250820/스크린샷 2025-08-21 092144.png>) 
...
```
    li      sp,0x90              # sp ← 0x90 (스택 베이스를 0x90으로 설정)
main:
    addi    sp,sp,-48            # 48바이트 스택 프레임 확보: sp = 0x90 - 48 = 0x48
